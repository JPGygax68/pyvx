...
class APIFilter:
    def __init__(self, header_files, prefix, include_dirs=[], ppdefs={}, include_before=[]):
        self.prefix = prefix
    ...
    def read_header(self, filename):
        args = ["-I%s" % incdir for incdir in self.include_dirs]
            ...
            if cursor.kind == CursorKind.ENUM_DECL:
                ...
                if utdt.kind == TypeKind.POINTER:
                    ...
                    if ca.kind == TypeKind.FUNCTIONPROTO:
                        ...
                        args = ['%s' % var_decl_to_str(_) for _ in
                                ch[1:]]  # 1 if ch[0].kind == CursorKind.TYPE_REF else 0:]]
